          ...
          <div className="container mx-auto max-w-6xl px-6 lg:px-12">
            <ScrollReveal className="flex flex-col gap-16">
              ...
              <div className="grid gap-6 md:grid-cols-3">
                <ScrollReveal delay={0.1} className="mission-card group">
                  <span className="mission-card-label">Human Director</span>
                  <div className="relative z-10 mt-6 flex flex-col gap-5">
                    <div className="flex items-center gap-4">
                      <div className="mission-card-icon">
                        <Users />
                      </div>
                      <h3 className="mission-card-title">人間の再定義</h3>
                    </div>
                ...
                <ScrollReveal delay={0.2} className="mission-card group">
                  <span className="mission-card-label">AI Workforce</span>
                  <div className="relative z-10 mt-6 flex flex-col gap-5">
                    <div className="flex items-center gap-4">
                      <div className="mission-card-icon">
                        <Bot />
                      </div>
                      <h3 className="mission-card-title">自己進化</h3>
                    </div>
                    <p className="mission-card-description">
                ...
                <ScrollReveal delay={0.3} className="mission-card group">
                  <span className="mission-card-label">Profitable</span>
                  <div className="relative z-10 mt-6 flex flex-col gap-5">
                    <div className="flex items-center gap-4">
                      <div className="mission-card-icon">
                        <TrendingUp />
                      </div>
                      <h3 className="mission-card-title">黒字経営</h3>
                    </div>
                    <p className="mission-card-description">
